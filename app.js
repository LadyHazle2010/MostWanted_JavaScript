    ...
    switch (searchType) {
        ...
        case "no":
            //! TODO #4: Declare a searchByTraits (multiple traits) function //////////////////////////////////////////
                ...
                searchByTraits(people).filter(function(people){
                    (people.searchByTraits === searchResults)
            ...
            // let single, multiple = searchByTraits(people);
    ...
    switch (displayOption) {
        case "info":
            ...
            function displayPerson(person){
                ...
                localStorage.setItem('testJSON', person);
            }
